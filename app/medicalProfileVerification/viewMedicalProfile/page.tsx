              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg">{medicalReport.verificationInfo.patientName}</p>
                  </div>
                  {medicalReport.verificationInfo.referenceID && (
                    <div>
                      <p className="text-sm font-medium text-gray-500">Reference ID</p>
                      <p className="text-lg">{medicalReport.verificationInfo.referenceID}</p>
                    </div>
                  )}
                  <div>
                    <p className="text-sm font-medium text-gray-500">Verified</p>
                    <p className="text-lg">{medicalReport.verificationInfo.isVerified ? 'Yes' : 'No'}</p>
                  </div>
                  {medicalReport.verificationInfo.verifiedAt && (
                    <div>
                      <p className="text-sm font-medium text-gray-500">Verified At</p>
                      <p className="text-lg">{formatDate(medicalReport.verificationInfo.verifiedAt)}</p>
                    </div>
                  )}
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg capitalize">{medicalReport.document_metadata.documentType.replace('_', ' ')}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">Date of Issue</p>
                    <p className="text-lg">{formatDate(medicalReport.document_metadata.dateOfIssue)}</p>
                  </div>
                  {medicalReport.document_metadata.DOB && (
                    <div>
                      <p className="text-sm font-medium text-gray-500">Date of Birth</p>
                      <p className="text-lg">{formatDate(medicalReport.document_metadata.DOB)}</p>
                    </div>
                  )}
                  {medicalReport.document_metadata.validTill && (
                    <div>
                      <p className="text-sm font-medium text-gray-500">Valid Till</p>
                      <p className="text-lg">{formatDate(medicalReport.document_metadata.validTill)}</p>
                    </div>
                  )}
                  {medicalReport.document_metadata.healthcareProvider && (
                    <div className="md:col-span-2">
                      ...
                      <p className="text-lg">{medicalReport.document_metadata.healthcareProvider}</p>
                    </div>
                  )}
                </div>
              </CardContent>
